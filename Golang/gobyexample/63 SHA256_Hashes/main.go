/*
	...
	identities for binary or text blobs. For example, TLS/SSL
	certificates use SHA256 to compute a certificate's
...
/*
	Go implements several hash function in various 'crypto/*'
	packages.
*/
import (
	"crypto/sha256"
