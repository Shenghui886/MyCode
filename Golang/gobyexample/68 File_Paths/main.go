/*
	...
	construct file path in a way that is portable between
...
func main() {
	...
	*/
	...
	/*
		You should always use 'Join' instead of concatenating '/s'
		or '\s' manually. In addition to providing portability,
		'Join' will also nomalize path by removing superfluouts
	...
	*/
	...
	/*
		...
		and the file. Alternatively, 'Split' will return both in the
		same call.
	*/
	...
	/*
		We can check whether a path in absolute.
	*/
	...
	*/
	...
	/*
		'Rel" finds a relative paah between a 'base' and a 'target'.
		It returns an error if the target cannot be made relative
		to base.
	*/
