...
func main() {
	...
	*/
	...
	/*
		...
		with 'MkdirAll'. This is similar to the command-line
		'mkdir -p'.
	*/
	...
	*/
	...
	/*
		'Chidr' lets us change the current working directory,
		similarly to 'cd'.
	*/
	...
	*/
	...
	/*
		...
		sub-directories. 'WalkDir' accepts a callback function to
