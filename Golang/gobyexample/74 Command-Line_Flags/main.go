...
/*
	Go provides a flag package supporting basic command-
	line flag parsing. We'll use this package to implement
	our example command-line program.
*/
import (
	"flag"
	"fmt"
...
func main() {
	...
	*/
	...
	/*
		...
		that we need to pass in a pointer to the flag declaration
		function.
	*/
	var svar string
	...
	*/
	...
	/*
		...
		dereference the pointers with e.g. '*wordPtr' to get
...
/*
	...
	# positional arguments (otherwise the flags will be interpreted
