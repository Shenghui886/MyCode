/*
	Throughtout program execution, we often want to create
	data that isn't needed after the program exits. 'Temporary
	files and directories' are useful for this purpose since
...
func main() {
	/*
		...
		'os.CreateTemp' will create the file in the default location
		for our OS.
	*/
	...
	/*
		Display the name of the temporary file. On Unix-based
		OSes the directory will likely be '/tmp'. The file name
		starts with the prefix given as the second argument to
		'os.CreateTemp' and the rest is chosen automatically to
		ensure that concurrent calls will always create different
		file names.
	*/
