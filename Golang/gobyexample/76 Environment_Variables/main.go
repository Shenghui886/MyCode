/*
	...
	[conveying configuration to Unix programs]
	(https://www.12factor.net/config). Let's look at how to
...
func main() {
	...
	*/
	...
	/*
		...
		environment. This returns a slice of string in the form
		'KEY=value'. You can 'strings.SplitN' them to get the key
