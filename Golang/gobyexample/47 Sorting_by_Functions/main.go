...
func main() {
	...
	/*
		We implement a comparison function for string length.
	...
	*/
	...
	/*
		Note: if the 'Person' struct is large, you may want the slice to
		contain *Person instead and adjust the sorting function
