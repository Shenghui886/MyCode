...
func main() {
	...
	/*
		...
		work and collect their results. We make 2 channels for
		this.
	*/
	const numJobs = 5
	...
	*/
	...
	/*
		Finally we collect all the results of the work. This alse
		ensures that the worker goroutines have funished. An
		Alternative way to wait for multiple goroutines is to
		use a [WaitGroup].
	*/
	for a := 1; a <= numJobs; a++ {
		<-results
